...
import com.WorkStudySync.filter.CustomJwtFilter;
...
public class SecurityConfig {
	...
	/*
	 * Spring Security 6~ Thay doi thong tin cau hinh cua Security: Phan quyen,
	 * chung thuc,...
	 */
//    Khởi tạo chuẩn mã hoá sử dụng và lưu trên IOC
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		return http.csrf(csrf -> csrf.disable())
				...
				.addFilterBefore(customJwtFilter, UsernamePasswordAuthenticationFilter.class).build();
	}
